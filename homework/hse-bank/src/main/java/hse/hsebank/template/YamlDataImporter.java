...
public class YamlDataImporter extends DataImporter {
    ...
    protected List<BankAccount> parseAccounts(String content) {
        try {
            ...
            System.err.println("Error parsing YAML accounts: " + e.getMessage());
        }
    ...
    protected List<Category> parseCategories(String content) {
        try {
            ...
            System.err.println("Error parsing YAML categories: " + e.getMessage());
        }
        return new ArrayList<>();
    }
    ...
    protected List<Operation> parseOperations(String content) {
        try {
            ...
            System.err.println("Error parsing YAML operations: " + e.getMessage());
        }
        return new ArrayList<>();
    }
